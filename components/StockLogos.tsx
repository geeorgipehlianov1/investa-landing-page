...
export function LaravelLogo(props: IconProps) {
  return (
...
export function TupleLogo(props: IconProps) {
  return (
    <svg viewBox='0 0 40 40' fill='#fff' aria-hidden='true' {...props}>
      <path
        fillRule='evenodd'
...
export function TransistorLogo(props: IconProps) {
  return (
    <svg viewBox='0 0 40 40' fill='#fff' aria-hidden='true' {...props}>
...
export function DiageoLogo(props: IconProps) {
  return (
    <svg
      viewBox='0 0 40 40'
      fill='#fff'
...
export function StaticKitLogo(props: IconProps) {
  return (
    <svg viewBox='0 0 40 40' fill='#fff' aria-hidden='true' {...props}>
...
export function StatamicLogo(props: IconProps) {
  return (
    <svg viewBox='0 0 40 40' fill='#fff' aria-hidden='true' {...props}>
      <path
        fillRule='evenodd'
...
export function MirageLogo(props: IconProps) {
  return (
    <svg viewBox='0 0 40 40' fill='#fff' aria-hidden='true' {...props}>
      <path
        fillRule='evenodd'
...
export function ReversableLogo(props: IconProps) {
  return (
    <svg
      viewBox='0 0 40 40'
      fill='none'
...
export function DeviceArrowIcon(props: IconProps) {
  return (
...
export function DeviceCardsIcon(props: IconProps) {
  let id = useId();
...
export function DeviceClockIcon(props: IconProps) {
  return (
    <svg viewBox='0 0 32 32' aria-hidden='true' {...props}>
      <circle cx={16} cy={16} r={16} fill='#A3A3A3' fillOpacity={0.2} />
      <path
...
export function DeviceListIcon(props: IconProps) {
  return (
...
export function DeviceLockIcon(props: IconProps) {
  return (
    <svg viewBox='0 0 32 32' aria-hidden='true' {...props}>
      <circle cx={16} cy={16} r={16} fill='#A3A3A3' fillOpacity={0.2} />
      <path
...
export function DeviceChartIcon(props: IconProps) {
  return (
    <svg viewBox='0 0 32 32' fill='none' aria-hidden='true' {...props}>
      <path
        fillRule='evenodd'
